/************************************************
	DUCK HUNT JS 
		...
		A first draft...
**************************************************/
var levelArray = [["第1关",3,2,5,3,13],["第2关",5,3,6,4,10],["第3关",6,3,7,4,10],["第4关",3,10,7,11,18],["第5关",5,2,8,3,13], ["第6关",1,15,8,15,25]];
...
var theGame={
	...
	doWave: function(num){
		...
		$("#waves").html("回合 "+(theGame.currentWave+1)+" / "+theGame.levelWaves);
	...
	drawBullets: function(){
		...
		$("#ammo").html("<strong>子弹: </strong>"+bulletsText);
...
function makeLevel(){
	...
	$("#sniffDog").stop();
	theGame.loadLevel("自定义游戏",LCwaves,LCducks,LCdif,LCbullets,LCwavetime);		
}
